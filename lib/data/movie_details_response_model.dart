...
MovieDetailsResponseModel movieDetailsModelFromJson(String str) =>
    MovieDetailsResponseModel.fromJson(json.decode(str));

String movieDetailsModelToJson(MovieDetailsResponseModel data) =>
...
class MovieDetailsResponseModel {
  ...
  MovieDetailsResponseModel.fromJson(dynamic json) {
    adult = json['adult'];
