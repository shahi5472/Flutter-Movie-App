...
import 'package:flutter_movie_app/controllers/watch_details_controller.dart';
                        ...
                        children: [
                          ImageSlideshow(
                            ...
                            children: List.generate(
                                data.backdrops.take(5).length, (index) {
                              return CachedNetworkImage(
                                imageUrl: RestApi.getImage(
                          ...
                          Positioned(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  'In theaters ${formatDate(data.model.releaseDate!)}',
